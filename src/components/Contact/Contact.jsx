      ...
      <div className="container contact_container">
        <motion.div initial={{translateX:"-30%"}} whileInView={{translateX:"0%"}} transition={{duration:0.5}}  className="contact_options"style={{background:darkMode?"var(--color-primary-variant)":""}}>
          <article className="contact_option">
            ...
            <h5>varshneychirag321@gmail.com</h5>
            <a href="mailto:varshneychirag321@gmail.com" target='_blank'>Send a message</a>
          </article>
          <article className="contact_option">
            <AiOutlineFacebook className='contact_option-icon'/>
            <h4>Messenger</h4>
            <a href="https://wa.me/qr/55NIXMTAOUPEF1" target='_blank'>Send a message</a>
          </article>
          <article className="contact_option">
            <BsWhatsapp className='contact_option-icon'/>
            <h4>WhatsApp</h4>
            <a href="https://api.whatsapp.com/send?phone=9027876094&text=Hi, parag I Want to hire you, you are interested to join our team " target='_blank'>Send a message</a>
          </article>
        </motion.div>
